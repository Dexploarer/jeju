...
let _cachedSecrets: Map<SecretId, string> | null = null
 ...
 */
export async function initializeSecrets(accessor: Address): Promise<void> {
...
export async function storeSecret(
  ...
  if (network === 'localnet') {
    log.warn(
      'Cannot store secrets in localnet mode - use environment variables',
    )
    return
  }
