  ...
  return new Elysia({ prefix: '/observability' })
      ...
      app
        ...
        .post('/gauge', ({ body }) => {
          ...
          body: t.Object({
            ...
            labels: t.Optional(t.Record(t.String(), t.String())),
            value: t.Number(),
            action: t.Union([t.Literal('set'), t.Literal('inc'), t.Literal('dec')]),
          }),
        })
        ...
        .get('/:name', ({ params, query }) => {
          const labels = query.labels ? JSON.parse(query.labels as string) : {}
      ...
      app
        ...
        .get('/', ({ query }) => {
          const spans = tracer.query({
            ...
            startTime: query.startTime ? parseInt(query.startTime as string, 10) : undefined,
            endTime: query.endTime ? parseInt(query.endTime as string, 10) : undefined,
            minDurationMs: query.minDurationMs ? parseInt(query.minDurationMs as string, 10) : undefined,
        ...
        .post('/spans', ({ body }) => {
          ...
          body: t.Object({
            ...
            attributes: t.Optional(t.Record(t.String(), t.Union([
              t.String(),
              t.Number(),
              t.Boolean(),
            ]))),
        ...
        // End a span
        .post('/spans/:spanId/end', ({ params, body }) => {
        ...
        // Add event to span
        .post('/spans/:spanId/events', ({ params, body }) => {
        ...
        // Set span attribute
        .post('/spans/:spanId/attributes', ({ params, body }) => {
    ...
    .group('/alerts', (app) =>
      app
        ...
        .post('/rules/:ruleId/toggle', ({ params, body }) => {
          if (body.enabled) {
